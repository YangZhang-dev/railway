...
import com.zzys.railway.biz.payservice.dao.entity.RefundDO;
import com.zzys.railway.biz.payservice.dao.mapper.PayMapper;
import com.zzys.railway.biz.payservice.dao.mapper.RefundMapper;
...
import com.zzys.railway.biz.payservice.handler.convert.RefundRequestConvert;
import com.zzys.railway.biz.payservice.handler.strategy.AliRefundNativeHandler;
import com.zzys.railway.biz.payservice.mq.event.RefundResultCallbackOrderEvent;
import com.zzys.railway.biz.payservice.mq.produce.RefundResultCallbackOrderSendProduce;
import com.zzys.railway.biz.payservice.remote.TicketOrderRemoteService;
import com.zzys.railway.biz.payservice.remote.dto.TicketOrderDetailRespDTO;
import com.zzys.railway.biz.payservice.remote.dto.TicketOrderPassengerDetailRespDTO;
...
//            refundDO.setUsername(each.getUsername());
            RefundDO refundDO = BeanUtil.convert(each, RefundDO.class);
            BeanUtil.convert(orderDetailRespDTO,refundDO);
            BeanUtil.convert(requestParam, refundDO);
            refundDO.setRefundTime(new Date());
