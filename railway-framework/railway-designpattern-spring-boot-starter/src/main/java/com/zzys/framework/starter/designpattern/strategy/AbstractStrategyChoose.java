package com.zzys.framework.starter.designpattern.strategy;

import com.zzys.framework.starter.convention.exception.ServiceException;
 ...
 *
 * @author YangZhang
 * @createTime 2023/09/23/ 11:11
 */
public class AbstractStrategyChoose implements ApplicationListener<ApplicationInitializedEvent> {
