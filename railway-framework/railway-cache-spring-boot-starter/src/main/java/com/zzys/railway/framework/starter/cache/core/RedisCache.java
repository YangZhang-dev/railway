...
import com.zzys.railway.framework.starter.base.SingletonHolder;
...
public class RedisCache implements DistributedCache{
    ...
    public Boolean putIfAllAbsent(@NotNull Collection<String> keys) {
        DefaultRedisScript<Boolean> actual = SingletonHolder.get(LUA_PUT_IF_ALL_ABSENT_SCRIPT_PATH, () -> {
